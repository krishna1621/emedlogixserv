...
public interface EindexRepository extends JpaRepository<Eindex, Integer> {
	...
	@Query(value = "SELECT t.parent_id as id,e.title as title,t.level as level,e.code as code,e.see as see,e.seealso as seealso,e.ismainterm as ismainterm from eindex e "
